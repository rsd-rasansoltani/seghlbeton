        ...
        $.ajax(
                {
                    ...
                    success: function (res) {
                        if (res === '1') {
                            $('#show_subscriber_msg').html('<div class=gen> <i class="fa fa-smile-o" aria-hidden="true"></i> Ø´ÙƒØ±Ø§ Ù„ÙƒØŒ ØªÙ… Ø§Ù„Ø§Ø´ØªØ±Ø§Ùƒ ÙÙŠ Ø§Ù„Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø¨Ø±ÙŠØ¯ÙŠØ© Ø¨Ù†Ø¬Ø§Ø­</div>');
                            $("#subscriber_form")[0].reset();
                        }

                        if (res === '5') {
                            $('#show_subscriber_msg').html('<div class=err><i class="fa fa-frown-o" aria-hidden="true"></i> Ù…Ù† ÙØ¶Ù„Ùƒ Ø§Ø¯Ø®Ù„ Ø¨Ø±ÙŠØ¯ Ø§Ù„ÙƒØªØ±ÙˆÙ†ÙŠ ØµØ­ÙŠØ­</div>');
                        }
                    }
                });
        e.preventDefault();
        ...
        $.ajax(
                {
                    ...
                    success: function (res) {
                        if (res === '1') {
                            $('#show_contact_msg').html('<div class=gen><i class="fa fa-smile-o" aria-hidden="true"></i> Ø´ÙƒØ±Ø§ Ù„ÙƒØŒ Ø³Ù†Ø±Ø¯ Ø¹Ù„ÙŠÙƒ ÙÙŠ Ø§Ù‚Ø±Ø¨ ÙˆÙ‚Øª</div>');
                            $("#contact_form")[0].reset();
                        }

                        if (res === '5') {
                            $('#show_contact_msg').html('<div class=err><i class="fa fa-frown-o" aria-hidden="true"></i> Ù…Ù† ÙØ¶Ù„Ùƒ Ø§Ø¯Ø®Ù„ Ø¨Ø±ÙŠØ¯ Ø§Ù„ÙƒØªØ±ÙˆÙ†ÙŠ ØµØ­ÙŠØ­</div>');
                        }
                    }
                });
        e.preventDefault();
